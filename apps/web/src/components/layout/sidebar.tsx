          ...
          <div className="rounded-md bg-muted px-3 py-2">
            <div className="flex items-center gap-1.5">
              <p className="text-xs text-muted-foreground">
                {session.user.orgType === "PLATFORM" ? "Platform" : session.user.orgType === "RESELLER" ? "Reseller" : "Client"}
              </p>
              {session.user.orgType === "PLATFORM" && (
      ...
      <nav className="flex-1 space-y-1 overflow-y-auto px-3 py-2">
        ...
        {session?.user?.orgType === "PLATFORM" && (
          <>
            ...
            {[
              { href: "/admin", label: "Pannello Admin", icon: ShieldCheck },
              { href: "/admin/organizations", label: "Organizzazioni", icon: Building2 },
              { href: "/admin/scan-type-defs", label: "Tipi di Scan", icon: Scan },
              { href: "/admin/service-types", label: "Tipi Servizio", icon: Target },
              { href: "/admin/contracts", label: "Contratti", icon: FileText },

  ...
  const scanTypeDefsData = [
    {
      ...
      description: "Individua host attivi nella rete. Nessuna porta scansionata, solo verifica presenza.",
      engine: "NMAP",
      defaultConfig: { mode: "DISCOVERY", timing: 3 },
    },
    {
      name: "Port Scan",
      slug: "port-scan",
      description: "Scansione porte con rilevamento servizi e versioni (top 1000 porte).",
      engine: "NMAP",
      defaultConfig: { mode: "FULL", timing: 3 },
    },
    {
      name: "Vulnerability Scan",
      slug: "vuln-scan",
      description: "Rilevamento vulnerabilità note tramite script automatici (lento, invasivo).",
      engine: "NMAP",
      defaultConfig: { mode: "VULN", timing: 2 },
    },
    {
      name: "CVE Scan",
      slug: "cve-scan",
      description: "Ricerca CVE note sugli asset — severità critical/high/medium.",
      engine: "NUCLEI",
      defaultConfig: { templates: ["cves"], severity: "critical,high,medium", rateLimit: 50 },
    },
    {
      name: "Web Application Scan",
      slug: "webapp-scan",
      description: "Analisi di misconfigurazioni, esposizioni e tecnologie web.",
      engine: "NUCLEI",
      defaultConfig: { templates: ["exposures", "misconfiguration"], rateLimit: 50 },
    },
    {
